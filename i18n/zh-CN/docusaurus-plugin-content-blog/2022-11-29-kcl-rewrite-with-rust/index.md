...
最后，如果大家喜欢 KCL 语言这个项目，或想使用体验 KCL 用于自己的场景，或想使用 Rust 语言参与一个开源项目，欢迎大家访问 [https://github.com/KusionStack/community](https://github.com/KusionStack/community) 加入我们的社区一起参与讨论和共建 👏👏👏。
