  ...
  return (
    <section>
      <div className="container text--center">
        ...
        <div className="container text--center">
          <form
            action="https://kcl-lang.us21.list-manage.com/subscribe/post?u=058fb980b248a836995b4c09a&amp;id=05b7eecfe9&amp;f_id=007e2fe7f0"
            method="post"
          ...
          >
            ...
            >
              <input
                type="email"
                name="b_058fb980b248a836995b4c09a_05b7eecfe9"
                value=""
              />
            </div>
            <input
...
export const Form = ({ fireInput }: { fireInput?: () => void }) => {
  ...
  const onSubmit = useCallback(
    async (evt: React.FormEvent<HTMLFormElement>) => {
      ...
      try {
        await fetch(
          "https://kcl-lang.us21.list-manage.com/subscribe/post?u=058fb980b248a836995b4c09a&amp;id=05b7eecfe9&amp;f_id=007e2fe7f0",
          {
            method: "POST",
  ...
  return (
    <form
      className="text-white container text--center"
      action="https://kcl-lang.us21.list-manage.com/subscribe/post?u=058fb980b248a836995b4c09a&amp;id=05b7eecfe9&amp;f_id=007e2fe7f0"
      method="post"
      id="mc-embedded-subscribe-form"
      name="mc-embedded-subscribe-form"
